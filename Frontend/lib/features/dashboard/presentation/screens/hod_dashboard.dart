...
class _HodBody extends StatelessWidget {
              ...
              children: [
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Welcome, Dr. $firstName', style: GoogleFonts.inter(fontSize: 22, fontWeight: FontWeight.w700, color: DashboardColors.textPrimary)),
                      const SizedBox(height: 6),
                      Text('Department overview & management tools.', style: GoogleFonts.inter(fontSize: 14, color: DashboardColors.textSecondary)),
                    ],
                  ),
                ),
              ...
              child: Row(
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Computer Science & Engineering', style: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.w700, color: Colors.white)),
                      Text('Department Summary', style: GoogleFonts.inter(fontSize: 12, color: Colors.white70)),
                    ],
                  ),
                ],
              ),
