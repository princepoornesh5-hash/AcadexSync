...
class SuperAdminShortageCard extends StatelessWidget {
  final SuperAdminStudentShortage shortage;

  const SuperAdminShortageCard({super.key, required this.shortage});
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "${shortage.collegeName} • ${shortage.departmentName}",
                  ...
                  Text(
                    "${shortage.rollNumber} • ${shortage.semester}",
