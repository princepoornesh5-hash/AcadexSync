...
void main() {
  ...
  group('Release Mode Hardening & Security Boundary Tests', () {
    ...
    test('3. Providers resolve to Real Firebase Repositories when Mock is disabled', () {
      ...
      expect(container.read(notificationRepositoryProvider), isA<ApiNotificationRepository>());
      expect(container.read(timetableRepositoryProvider), anyOf(isA<FirebaseTimetableRepository>(), isA<ApiTimetableRepository>()));
      expect(container.read(notesRepositoryProvider), isA<ApiNotesRepository>());
